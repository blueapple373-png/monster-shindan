...
export default function LP() {
  ...
  const faqs = [
    {
      q: "毎日課題をこなせるか不安です",
      a: "この4週間は、毎日続けられる人のためのプログラムではありません。止まってしまうことも、参加できなかった週も、立て直しルートを作るための材料として扱います。",
    },
    {
      q: "心理士や医師ではないですか？",
      a: "MINAMI MINDLABは医療機関ではありません。本プログラムは心理療法や医療の代替ではなく、実生活で使える立て直し方を一緒に探す場です。現在、危機状態や強い希死念慮がある場合は、まず医療機関や専門窓口にご相談ください。",
    },
    {
      q: "オンラインで完結しますか？",
    ...
    {
      q: "途中で継続が難しくなった場合は？",
      a: "参加できなかった週や、連絡を返せなかった時期も、止まり方の観察材料として扱います。脱落とは考えません。参加できそうな状態になった時点から再接続します。",
    },
    {
      q: "4週間で終了してもいいですか？",
      a: "問題ありません。4週間だけでも、止まり方の仮説と最初の立て直しルートを持ち帰れる設計です。継続プログラムは希望する方にのみご案内します。",
    },
  ];
  const weeks = [
    {
    ...
    },
    {
      week: "3週目",
      title: "合わなかった方法を見直す",
      desc: "試せなかったことや、試してもうまくいかなかったことも失敗にはしません。別の方法や、介入するタイミングを一緒に考えます。",
    },
    {
      week: "4週目",
      title: "自分の立て直しルートをまとめる",
      desc: "4週間で分かったことと、実際に試したことを整理し、今後も修正していける「立て直しルート仮説」にまとめます。",
    },
  ];
  return (
    <div
        ...
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          >
            ...
            <p style={{ fontSize: 15, lineHeight: 2, color: "#4A4A5A", margin: 0 }}>
              ...
              止まってしまった後に日常を止めすぎないための考え方と実践方法を届けています。
            </p>
          </div>
          {bioOpen && (
            <div
            ...
            >
              {[
                ...
                "私は、つらい時に「考えすぎだよ」「気にしなければいい」と言われても、あまり納得できませんでした。なぜ、こんなに反応してしまうのか。何が引き金になっているのか。理解しているのに、なぜ行動を変えられないのか。止まってしまった後、どうすれば日常を止めすぎずにいられるのか。",
                ...
                "だから今は、感情をなくす方法ではなく、感情に飲み込まれた後に立て直す方法を考えています。不安になってもいい。自己否定してもいい。何もできない日があってもいい。ただ、そのまま何日も人生が止まり続けるのではなく、少しだけ生活を再開する。何もできない自分を責め続けるのではなく、今できる小さな行動を選ぶ。",
                "私は、感情に振り回されない強い人になったわけではありません。今でも揺れることはあります。理解していても、うまくできない日があります。それでも以前より、何が起きているのかを整理し、止まった後に立て直すための方法を持てるようになりました。",
